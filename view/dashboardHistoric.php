    ...
    <section id="side-bar-dash">
        <section id="navbar-left">
            <ul class="nav-menu">
                ...
                <li><a href="https://mailtrap.io/inboxes/3538112/messages" target="_blank"><img src="../assets/img/inbox-24.ico" alt=""> <span> Mail</span></a></li>
                ...
                <li id="settings-dashboard"><a href=""><img src="../assets/img/settings-19-24.ico" alt=""> <span>Statistiques</span> </a></li>
